  ...
  return (
    ...
    >
      ...
      <section className="w-full flex flex-col items-center">
        ...
        >
          <p className="text-sm md:text-base">{t("phone.label")}</p>
        ...
        <a
          ...
          className="flex flex-col w-full space-x-4 text-foreground hover:bg-accent/50 px-5 py-[10px]"
        >
          <p className="text-sm md:text-base">{t("email.label")}</p>
          <span className="text-base md:text-lg font-semibold">
            {contactsMeta.email.value}
          </span>
        </a>

        <Button className="flex w-60 flex-col mx-5 mt-10 mb-2.5, hover:text-[#25d366] hover:bg-background transition-transform duration-200 ease-in-out hover:scale-105">
          <a
        ...
        <Button className="flex w-60 flex-col mx-5 mt-2.5 mb-10 hover:text-[#1c93e3] hover:bg-background transition-transform duration-200 ease-in-out hover:scale-105">
          <a
